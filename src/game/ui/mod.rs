...
fn spawn_game_ui(
    ...
    image_handles: Res<HandleMap<ImageKey>>,
    fonts: Res<HandleMap<FontKey>>,
    predictions: Res<Predictions>, // Pull in the struct of predictions, this will help the us determine what buttons to show
) {
    commands
        .ui_root()
                                        ...
                                        .with_children(|commands| {
                                            ...
                                            for i in 0..4 {
                                                let (image_key, game_action) = match i {
                                                    ...
                                                    1 => (ImageKey::ParrotButton, GameAction::Parrot),
                                                    2 => (ImageKey::DarkmagicButton, GameAction::DarkMagic),
                                                    3 => (ImageKey::SpyglassButton, GameAction::SpyGlass),
