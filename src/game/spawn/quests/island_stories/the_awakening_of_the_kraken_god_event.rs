...
fn challenge_kraken_god(actions: &mut StoryActions) {
    ...
    match (wind, moisture) {
        (W::GaleForce, M::Humid) => {
            actions.delta_items(Item::Gold, 50000);
            actions.delta_items(Item::Cannon, 20);
            actions.delta_health(500);
            actions.delta_crew(50);
        ...
        (W::High, M::Comfortable) => {
            actions.delta_items(Item::Gold, 30000);
            actions.delta_items(Item::Cannon, 10);
            actions.delta_health(300);
            actions.delta_crew(30);
        ...
        (W::Low | W::None, _) => {
            ...
            actions.delta_items(Item::Gold, 10000);
        ...
        _ => {
            actions.delta_items(Item::Gold, 20000);
