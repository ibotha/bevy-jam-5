...
pub fn sighted_trinket_seller(actions: &mut StoryActions) -> DayEvent {
    ...
    set_course_northern_sea(actions)
        ...
        .line(trinket_seller!(if actions.get_item(Item::SirenKiller) == 0 {"I also have this blade I retrieved from a nearby shipwreck. Only 150 gold."} else {"other than that..."}))
